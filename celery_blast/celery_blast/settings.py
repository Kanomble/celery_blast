...
TAXDB_SHA256 = config("TAXDB_SHA256", default="")
CDD_DATABASE_SHA256 = config("CDD_DATABASE_SHA256", default="")
REFSEQ_ASSEMBLY_FILE = config('REFSEQ_ASSEMBLY_FILE')
REFSEQ_URL = config("REFSEQ_URL")
REFSEQ_ASSEMBLY_SHA256 = config("REFSEQ_ASSEMBLY_SHA256", default="")
GENBANK_ASSEMBLY_FILE = config("GENBANK_ASSEMBLY_FILE")
GENBANK_URL = config("GENBANK_URL")
GENBANK_ASSEMBLY_SHA256 = config("GENBANK_ASSEMBLY_SHA256", default="")

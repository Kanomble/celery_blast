...
service_urls = [
    ...
    path('<int:project_id>/<str:filename>/<str:project_type>/target_sequences',views.one_way_download_target_sequences, name='one_way_target_sequence_download')
...
ajax_urls = [
    path('<int:remote>/<int:project_id>/ajax_one_way_wp_to_links',views.ajax_one_way_wp_to_links,name='ajax_one_way_wp_to_links')
]
urlpatterns = [
